...
while x <= 200:
    ...
    draw_line(250, 250, x+250, y+250, screen, [(255+screen[500-1-y-250][x+250][0])/2,                                (85+screen[500-1-y-250][x+250][1])/2,                                    (int(math.floor(((x+200)*255)/401))+screen[500-1-y-250][x+250])/2])
    draw_line(250, 250, x+250, 250-y, screen, [(int(math.floor(((x+200)*255)/401))+screen[500-1+y-250][x+250][0])/2, (85+screen[500-1+y-250][x+250][1])/2,                                    (255+screen[500-1+y-250][x+250])/2])
    draw_line(250, 250, x1+250, y1+250, screen, [(85+screen[500-1-y1-250][x1+250][0])/2,                             (255+screen[500-1-y1-250][x1+250][1])/2,                                 (int(math.floor(((y1+200)*255)/401))+screen[500-1-y1-250][x1+250])/2])
    draw_line(250, 250, 250-x1, y1+250, screen, [(85+screen[500-1-y1-250][250-x1][0])/2,                             (int(math.floor(((y1+200)*255)/401))+screen[500-1-y1-250][250-x1][1])/2, (255+screen[500-1-y1-250][250-x1])/2])
    x+=1
    y1+=1
